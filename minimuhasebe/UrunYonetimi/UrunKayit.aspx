    ...
    <div class="product-create">
        ...
        <div class="product-form">
            ...
            <div class="form-group field-product-Quantity required">
                <label class="control-label" for="product-price">Quantity</label>
            ...
            <div class="form-group field-product-tax_rate required">
                <label class="control-label" for="product-tax_rate">Tax Rate</label>
            ...
            <div class="form-group field-product-decription">
                <label class="control-label" for="product-decription">Decription</label>
